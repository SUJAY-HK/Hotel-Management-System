...
import { appIndexHTML, appViteConfigJs, appViteConfigTs, oldIndexHTML, } from "./paths.js";
...
if (gitStatus) {
    cancel("Aborted");
    console.info("This git repository has untracked files or uncommitted changes:");
    console.info(gitStatus);
    console.info("Remove untracked files, stash or commit any changes, and try again.");
    process.exit(0);
}
