...
const importDirective = ({ tsConfig, jsConfig, svg, setupProxy }) => `\
import { resolve } from "node:path";
import { readFileSync, existsSync } from "node:fs";
import { defineConfig, loadEnv, Plugin${svg ? ", createFilter, transformWithEsbuild" : ""} } from "vite";
import react from "@vitejs/plugin-react";
${tsConfig || jsConfig ? 'import tsconfigPaths from "vite-tsconfig-paths";' : ""}
${setupProxy ? 'import setupProxy from "./src/setupProxy";' : ""}
`;
const defineConfig = ({ tsConfig, jsConfig, svg, proxy, setupProxy, }) => `\
...
export const writeViteConfig = (options) => {
